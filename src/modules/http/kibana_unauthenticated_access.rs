...
impl HttpModule for KibanaUnauthenticatedAccess{
	async fn scan(
		...
		if body.contains(r#"</head><body kbn-chrome id="kibana-body><kbn-initial-state"#) ||
			body.contains(r#"<div class = ui-app-loading"><h1><strong>Kibana</strong><small>&nbsp;isloading."#) || Some(0) == 
			body.find(r#"|| body.contains("#) || body.contains(r#"<div class="kibanaWelcomeLogo></div></div></div><div class="kibanaWelcomeText">Loading Kibana</div></div>"#) {
