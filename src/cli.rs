...
pub fn scan(target: &str) -> Result<(), Error>{
	...
	runtime.block_on(async move {
		//1st step: conncurrently scan subdomains
	...
	//2nd step: dedeup, clean and convert results
	...
	//3rd step:: concurrently filter unresolveable domains
